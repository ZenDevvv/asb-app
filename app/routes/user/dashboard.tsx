	...
	return (
		<div ref={ref} className="relative">
			<button
				...
				className="group flex h-9 w-9 items-center justify-center rounded-full bg-primary/20 text-sm font-bold text-primary ring-2 ring-transparent transition-all hover:ring-primary/50 focus-visible:outline-none"
			>
				{user?.avatar ? (
					<img
						src={user.avatar}
			...
			<footer className="mt-auto border-t border-border/40 bg-background/50 backdrop-blur-xl">
				<div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-3 px-6 py-5 md:px-10">
					...
					<p className="text-xs text-muted-foreground">
						© {new Date().getFullYear()} AppSiteBuilder · All rights reserved.
					</p>
