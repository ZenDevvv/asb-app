...
export const BLOCK_REGISTRY: Record<BlockType, BlockRegistryEntry> = {
  ...
  rsvp: {
    ...
    defaultProps: {
      ...
      submitUrl: "#",
      postcardTitle: "Kindly Reply",
      postcardQuote: "\"Love is the flower you've got to let grow.\"",
      postcardQuoteAuthor: "John Lennon",
      returnToLabel: "Return To:",
      returnToName: "Jane & John",
      returnToAddressLine1: "123 Bohemian Way",
      returnToAddressLine2: "Tulum, Mexico 77760",
      bgColor: "",
      fgColor: "",
    },
    defaultStyle: { tilt: 0 },
      ...
      options: [
        {
          label: "Classic",
          value: "default",
          appearances: [{ label: "Classic", value: "classic" }],
        },
        {
          label: "Postcard",
          value: "postcard",
          appearances: [{ label: "Reply Card", value: "postal-card" }],
        },
      ],
    },
    editableProps: [
      ...
      { key: "postcardTitle", label: "Postcard Title", type: "short-text" },
      { key: "postcardQuote", label: "Postcard Quote", type: "short-text" },
      { key: "postcardQuoteAuthor", label: "Postcard Quote Author", type: "short-text" },
      { key: "returnToLabel", label: "Return Label", type: "short-text" },
      { key: "returnToName", label: "Return Name", type: "short-text" },
      { key: "returnToAddressLine1", label: "Return Address Line 1", type: "short-text" },
      { key: "returnToAddressLine2", label: "Return Address Line 2", type: "short-text" },
