...
export default [
	...
	route("/project/cms/preview/:slug", "routes/project/cms-view.tsx"),
	route("/project/cms/view/:slug", "routes/project/cms-public-view.tsx"),
	route("/project/preview/:slug", "routes/project/preview.tsx"),
	...
	route("/project/view/:slug", "routes/view/project.tsx"),
	route("/cms/view/:templateId", "routes/view/cms-template.tsx"),
